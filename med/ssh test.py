...
if __name__ == '__main__':
    ...
    sftp_get(ip='31.187.96.100', user="nadya", remote_file="/home/nadya/namepapka/namefile", local_file=r'C:\Users\wd10\PycharmProjects\TestsCov\med\testdir\namefile')

    #cmds = ['cd namepapka', ' ls -la']
