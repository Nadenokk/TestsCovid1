...
class CreateOKI4(unittest.TestCase):
    ...
    def test_create_OKI4(self):
        ...
        driver.find_element_by_id("itemForm:tabView:rotavirusRnaResult_label").click()
        driver.find_element_by_id("itemForm:tabView:rotavirusRnaResult_1").click()
        driver.find_element_by_id("itemForm:tabView:adenovirusDnaResult_label").click()
