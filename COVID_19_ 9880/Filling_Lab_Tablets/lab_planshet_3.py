...
class LabPlanshet3(unittest.TestCase):
    ...
    def test_lab_planshet(self):
        ...
        driver.find_element_by_css_selector("#j_idt68 > div.nano.layout-tabmenu-nav > ul > li:nth-child(3) > a > div").click()
        driver.find_element_by_css_selector(u"a[title=\"Лабораторные планшеты. Версия 3.0.\"] > span").click()
