...
class LabPlanshet1(unittest.TestCase):
    ...
    def lab_planshet(self):
        ...
        driver.find_element_by_id("buttonsForm:j_idt94").click()
        driver.find_element_by_id("barcodeForm:j_idt108").click()
        driver.find_element_by_id("barcodeForm:j_idt108").click()
        driver.find_element_by_css_selector("td").click()
        driver.find_element_by_id("barcodeForm:j_idt108").clear()
        driver.find_element_by_id("barcodeForm:j_idt108").send_keys(barcode1)
        driver.find_element_by_id("barcodeForm:j_idt108").send_keys(Keys.ENTER)
        time.sleep(6)
        assert driver.find_element_by_css_selector("#tabletForm\:tube_1_7_content > span.content-value").text == iss1
        driver.find_element_by_id("barcodeForm:j_idt108").clear()
        driver.find_element_by_id("barcodeForm:j_idt108").send_keys(barcode2)
        driver.find_element_by_id("barcodeForm:j_idt108").send_keys(Keys.ENTER)
        time.sleep(6)
        assert driver.find_element_by_css_selector("#tabletForm\:tube_2_7_content > span.content-value").text == iss2
        driver.find_element_by_id("barcodeForm:j_idt108").clear()
        driver.find_element_by_id("barcodeForm:j_idt108").send_keys(barcode3)
        driver.find_element_by_id("barcodeForm:j_idt108").send_keys(Keys.ENTER)
        time.sleep(6)
        ...
        driver.find_element_by_id("buttonsForm:j_idt100").click()
        time.sleep(2)
