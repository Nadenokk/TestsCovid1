...
class CreatePassanger(unittest.TestCase):
    ...
    def test_create_passanger(self):
        ...
        driver.find_element_by_xpath('//label[@for="itemForm:tabView:sex:0"]').click()
        #time.sleep(3)
        #driver.find_element_by_css_selector("label.itemForm:tabView:sex:0").click()
        ...
        driver.find_element_by_id("itemForm:tabView:registerSubjectRf_link").click()
        driver.find_element_by_css_selector("#itemForm\:tabView\:registerSubjectRf_label").click()
        ...
        driver.find_element_by_id("itemForm:tabView:registerLocality_input").send_keys(u"Ярославль"+Keys.TAB)
        ...
        driver.find_element_by_css_selector("#itemForm\:tabView\:factSubjectRf_label").click()
        ...
        driver.find_element_by_id("itemForm:tabView:factLocality_input").send_keys(u"Ярославль"+Keys.TAB)
