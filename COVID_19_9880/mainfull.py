...
from vich.vich_sert import Vich
from vich.vich_negative import Vich3
from vich.positiv_VICH import Vich2
# Get all tests
...
tc31 = unittest.TestLoader().loadTestsFromTestCase(Vich)
tc32 = unittest.TestLoader().loadTestsFromTestCase(Vich3)
tc33 = unittest.TestLoader().loadTestsFromTestCase(Vich2)
...
smokeTest = unittest.TestSuite([tc1, tc2, tc3, tc4, tc5, tc6, tc7, tc8, tc9, tc10, tc11, tc12, tc13, tc14, tc15,
                                 tc16, tc18, tc19, tc20, tc23, tc24, tc25, tc26, tc27, tc30, tc31, tc32, tc33])
