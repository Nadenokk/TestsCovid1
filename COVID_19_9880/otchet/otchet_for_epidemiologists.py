...
class OtchetForEpidemiologists(unittest.TestCase):
    ...
    def test_otchet_for_epidemiologists(self):
        ...
        driver.find_element_by_css_selector(
            "#buildForm\:j_idt78_panel > div.ui-selectcheckboxmenu-items-wrapper > ul > li:nth-child(86) > div > div.ui-chkbox-box.ui-widget.ui-corner-all.ui-state-default > span").click()
        #driver.find_element_by_css_selector("#buildForm\:j_idt79_panel").click()
        driver.find_element_by_css_selector(
            "#buildForm\:j_idt78_panel > div.ui-selectcheckboxmenu-items-wrapper > ul > li:nth-child(81) > div > div.ui-chkbox-box.ui-widget.ui-corner-all.ui-state-default > span").click()
        driver.find_element_by_css_selector("body").click()
        driver.find_element_by_id("buildForm:j_idt88:j_idt91").click()
        time.sleep(2)
        driver.find_element_by_id("buildForm:j_idt88:j_idt96:j_idt98:0:filter").click()
        driver.find_element_by_id("buildForm:j_idt88:j_idt96:j_idt98:0:filter").clear()
        driver.find_element_by_id("buildForm:j_idt88:j_idt96:j_idt98:0:filter").send_keys("ГЭ")
        time.sleep(2)
        ...
        '''
        driver.find_element_by_id("buildForm:j_idt88:j_idt101").click()
