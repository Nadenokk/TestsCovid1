...
class CreateOKI4(unittest.TestCase):
    def setUp(self):
    ...
    def genlog(self):    
        ...
        if not os.path.exists("Logs"):
            os.mkdir("Logs")
        handler = logging.FileHandler(str('logs/' + (time.strftime(''%d.%m.%Y_%H.%M_'', (time.localtime())))  + 'Create_OKI4.log'))
    ...
    def test_create_OKI4(self):
        ...
        driver.find_element_by_css_selector("#buttonsForm\:createOki4").click()
        ...
        time.sleep(2)
        driver.find_element_by_css_selector("#buttonsForm\:createOki4")
