...
class CreatePcrBarcode(unittest.TestCase):
    ...
    def test_create_barcode(self):
        ...
        driver.find_element(By.CSS_SELECTOR,"#j_idt71 > div.nano.layout-tabmenu-nav.has-scrollbar > ul > li:nth-child(6) > a").click()
        driver.find_element(By.CSS_SELECTOR,u"a[title=\"Создание заявки на исследование 2\"] > span").click()
        driver.find_element(By.CSS_SELECTOR,"#buttonsForm\:prepareBarcodeDialog").click()
        time.sleep(2)
        driver.find_element(By.CSS_SELECTOR,"#barcodeForm\:j_idt85").click()
        driver.find_element(By.CSS_SELECTOR,"#barcodeForm\:j_idt85").clear()
        driver.find_element(By.CSS_SELECTOR,"#barcodeForm\:j_idt85").send_keys(barcode)
        driver.find_element(By.CSS_SELECTOR,"#barcodeForm\:j_idt85").send_keys(Keys.ENTER)
        ...
        driver.find_element(By.ID,"tableForm:main-table:j_id15").send_keys(u"един"+Keys.ENTER)
        ...
        driver.find_element(By.ID,"tableForm:main-table:j_id10").send_keys(u"сбер"+Keys.ENTER)
        driver.find_element(By.CSS_SELECTOR,"#tableForm").click()
        time.sleep(2)
        driver.find_element(By.CSS_SELECTOR,
            "#tableForm\:main-table_data > tr.ui-widget-content.ui-datatable-even.ui-datatable-selectable.ui-state-hover").click()
        ...
        driver.find_element(By.ID, "itemForm:tabView:direction").click()
        ...
        time.sleep(2)
        '''driver.find_element(By.ID,"itemForm:tabView:controlResearchDate_input").click()
        driver.find_element(By.ID,"itemForm:tabView:controlResearchDate_input").clear()
        driver.find_element(By.ID,"itemForm:tabView:controlResearchDate_input").send_keys("24.05.2021 8:52")'''
        driver.find_element(By.CSS_SELECTOR,"body.main-body").click()
        ...
        driver.find_element(By.CSS_SELECTOR,"#buttonsForm\:prepareBarcodeDialog")
