...
class CreatePulcovo(unittest.TestCase):
    ...
    def test_create_pulcovo(self):
        ...
        driver.find_element_by_css_selector("#j_idt71 > div.nano.layout-tabmenu-nav.has-scrollbar > ul > li:nth-child(2) > a").click()
        ...
        time.sleep(3)
        numberIss=driver.find_element_by_id("itemForm:number").get_attribute("value")
        ...
        driver.find_element_by_css_selector(
            "#j_idt72 > div.nano.layout-tabmenu-nav.has-scrollbar > ul > li:nth-child(2) > a").click()
        ...
        driver.find_element_by_id("filtersForm:j_idt106").send_keys(numberIss)
