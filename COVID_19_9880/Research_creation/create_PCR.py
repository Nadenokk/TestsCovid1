...
class CreatePCR(unittest.TestCase):
    ...
    def test_create_pcr(self):
        ...
        driver.find_element(By.CSS_SELECTOR,"#j_idt70 > div.nano.layout-tabmenu-nav.has-scrollbar > ul > li:nth-child(6) > a").click()
        ...
        time.sleep(2)
        driver.find_element(By.CSS_SELECTOR,"#tableForm\:main-table_data > tr.ui-widget-content.ui-datatable-even.ui-datatable-selectable").click()
        ...
        time.sleep(2)
        driver.find_element(By.CSS_SELECTOR,"span.ui-radiobutton-icon.ui-icon.ui-icon-blank.ui-c").click()
        #driver.find_element(By.CSS_SELECTOR,"#itemForm\:tabView\:materialType > tbody > tr > td:nth-child(1) > div > div.ui-radiobutton-box.ui-widget.ui-corner-all.ui-state-default > span").click()
        ...
        #  driver.find_element(By.ID,"itemForm:tabView:materialDate_input").send_keys(Keys.HOME, date)
        #time.sleep(2)
        ...
        driver.find_element(By.CSS_SELECTOR,"#itemForm\:tabView\:sex > tbody > tr > td:nth-child(1) > div > div.ui-radiobutton-box.ui-widget.ui-corner-all.ui-state-default > span").click()
        ...
        driver.find_element(By.ID,"itemForm:tabView:identityDocType_8").click()
        ...
        driver.find_element(By.ID,"itemForm:tabView:identityDocSeries").send_keys("V-пг")
        ...
        driver.find_element(By.ID,"itemForm:tabView:identityDocNumber").send_keys("677894")
        ...
        driver.find_element(By.ID,"itemForm:tabView:region_6").click()
        time.sleep(2)
        ...
        driver.find_element(By.CSS_SELECTOR,"#itemForm\:tabView\:homeCityArea_5").click()
        ...
        driver.find_element(By.CSS_SELECTOR,"#tableForm").click()
        time.sleep(2)
        driver.find_element(By.CSS_SELECTOR,"#tableForm\:main-table_data > tr.ui-widget-content.ui-datatable-even.ui-datatable-selectable.ui-state-hover").click()
        time.sleep(2)
        driver.find_element(By.CSS_SELECTOR,"#tableForm\:choose").click()
        driver.switch_to.window(window_before)
        ...
        driver.find_element(By.ID,"itemForm:tabView:sender").click()
        driver.find_element(By.CSS_SELECTOR,"#itemForm\:tabView\:medicalState > tbody > tr > td:nth-child(1) > div > div.ui-radiobutton-box.ui-widget.ui-corner-all.ui-state-default > span").click()
        driver.find_element(By.CSS_SELECTOR,"#itemForm\:tabView\:medicalState > tbody > tr > td:nth-child(1) > div > div.ui-radiobutton-box.ui-widget.ui-corner-all.ui-state-default > span").click()
        ...
        driver.find_element(By.CSS_SELECTOR,"body.main-body").click()
        driver.find_element(By.ID,"itemForm:tabView:controlResearchResult").click()
        driver.find_element(By.CSS_SELECTOR,"#itemForm\:tabView\:controlResearchResult_label").click()
        # driver.find_element(By.CSS_SELECTOR,"#itemForm\:tabView\:controlResearchResult_items").click()
        driver.find_element(By.ID,"itemForm:tabView:controlResearchResult_1").click()
        time.sleep(2)

        driver.find_element(By.CSS_SELECTOR,"body.main-body").click()
        driver.find_element(By.ID,"itemForm:tabView:controlPcr_input").click()
        driver.find_element(By.ID,"itemForm:tabView:controlPcr_input").clear()
        driver.find_element(By.ID,"itemForm:tabView:controlPcr_input").send_keys("1111")
        #driver.find_element(By.ID,"itemForm:j_id5").click()
        time.sleep(2)
        ...
        driver.find_element(By.CSS_SELECTOR,"#buttonsForm\:createPcr")
