...
class CreatePCR(unittest.TestCase):
    ...
    def test_create_pcr(self):
        ...
        driver.find_element_by_css_selector("#j_idt71 > div.nano.layout-tabmenu-nav.has-scrollbar > ul > li:nth-child(9) > a").click()
        ...
        driver.find_element_by_id("itemForm:tabView:identityDocType_8").click()
        ...
        driver.find_element_by_id("itemForm:tabView:identityDocSeries").send_keys("V-пг")
        ...
        driver.find_element_by_id("itemForm:tabView:identityDocNumber").send_keys("677894")
