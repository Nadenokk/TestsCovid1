...
class CreateAntitellGglGm(unittest.TestCase):
    ...
    def test_create_antitel_lGglGm(self):
        ...
        driver.find_element(By.CSS_SELECTOR,"#buttonsForm\:createAntibodiesSum").click()
        ...
        driver.find_element(By.ID,"itemForm:tabView:country_1").click()
        ...
        time.sleep(5)
        '''
        driver.find_element(By.ID,"itemForm:j_id12_button").click()
        driver.find_element(By.ID,"itemForm:j_id12_menu").click()
        time.sleep(2)
        driver.find_element(By.CSS_SELECTOR,"#itemForm\:j_id22").click()
        time.sleep(5)
        driver.find_element(By.ID,"itemForm:j_id12_button").click()
        driver.find_element(By.ID,"itemForm:j_id12_menu").click()
        time.sleep(2)
        ...
        driver.find_element(By.ID,"itemForm:tabView:antiValueSum_input").send_keys("11")
