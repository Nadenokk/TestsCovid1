...
class NewTablet(unittest.TestCase):
    ...
    def test_new_tablet(self):
        ...
        #планшеты
        driver.find_element(By.CSS_SELECTOR,
            "#j_idt71 > div.nano.layout-tabmenu-nav.has-scrollbar > ul > li:nth-child(5) > a > div > div.layout-tabmenu-tooltip-text").click()
        #driver.find_element(By.CSS_SELECTOR,"span.ui-button-text.ui-c").click()
        ...
        driver.find_element(By.ID,"covidResearchForm:tabView:tablet1_input").click()
