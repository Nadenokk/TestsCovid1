...
class NewTablet(unittest.TestCase):
    ...
    def test_new_tablet(self):
        ...
        driver.find_element_by_id("covidResearchForm:tabView:covid-researches-city_input").send_keys(u"Ярославь"+Keys.TAB)
        #time.sleep(1)
        ...
        driver.find_element_by_id("covidResearchForm:tabView:covid-researches-workAddressCity_input").send_keys(u"Ярославль"+Keys.TAB)
