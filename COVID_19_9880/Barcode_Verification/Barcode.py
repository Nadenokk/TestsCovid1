...
class Barcode1(unittest.TestCase):
    ...
    def test_barcode(self):
        ...
        time.sleep(2)
        driver.find_element_by_id("genForm:j_idt88_input").click()
        driver.find_element_by_id("genForm:j_idt88_input").clear()
        driver.find_element_by_id("genForm:j_idt88_input").send_keys("15")
        time.sleep(2)
        driver.find_element_by_id("genForm:j_idt90").click()
        time.sleep(9)
