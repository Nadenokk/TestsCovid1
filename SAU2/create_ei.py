...
class CreateEi(unittest.TestCase):
    ...
    def test_create_ei(self):
        ...
        driver.find_element_by_id("tableFieldItemForm2:receiptDate_input").send_keys("10.03.2022")
        driver.find_element_by_id("tableFieldItemForm2:medicalHistoryNumber").click()
        time.sleep(1)
        ...
        driver.find_element_by_id("j_idt78:j_idt97:receiptDate_input").send_keys("28.03.2022")
        ...
        driver.find_element_by_id("tableFieldItemForm2:arriveDateTo_input").send_keys("28.03.2022")
        driver.find_element_by_id("tableFieldItemForm2:city_input").click()
        driver.find_element_by_id("tableFieldItemForm2:j_idt207_content").click()
