...
class CreateOrder(unittest.TestCase):
    ...
    def test_create_order(self):
        ...
        #заполнение карточки
        driver.find_element_by_xpath(
            "//label[@for='j_idt75:j_idt94:sex:0']").click()
        driver.find_element_by_id("j_idt75:j_idt94:tf_addressesList_add").click()
        ...
        driver.find_element_by_id("j_idt75:j_idt94:tf_jobs_add").click()
        time.sleep(2)
        ...
        driver.find_element_by_id("j_idt75:j_idt94:tf_diagnoses_add").click()
        ...
        driver.find_element_by_id("j_idt75:j_idt78").click()
        time.sleep(4)
        assert driver.find_element_by_xpath(
