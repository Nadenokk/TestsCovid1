...
class CreateOrder(unittest.TestCase):
    ...
    def test_create_order(self):
        ...
        driver.find_element_by_id("tableForm:main-table:j_id14").send_keys(u"хеликс")
        ...
        time.sleep(2)
        driver.find_element_by_id("tableFieldItemForm:addressType_label").click()
        #time.sleep(1)
        driver.find_element_by_css_selector("#tableFieldItemForm\:addressType_panel").click()
        driver.find_element_by_css_selector("#tableFieldItemForm\:addressType_1").click()

        #driver.find_element_by_id("tableFieldItemForm:country_label").click()
        #driver.find_element_by_css_selector("#tableFieldItemForm\:country_panel").click()
        #driver.find_element_by_css_selector("#tableFieldItemForm\:country_129").click()
        #driver.find_element_by_id("tableFieldItemForm:region_label").click()
        #driver.find_element_by_css_selector("#tableFieldItemForm\:region_panel").click()
        #time.sleep(1)
        #driver.find_element_by_css_selector("#tableFieldItemForm\:region_1").click()
        #time.sleep(1)
        #driver.find_element_by_id("tableFieldItemForm:tableFieldPanel").click()
        ...
        driver.find_element_by_id("tableFieldItemForm:city_input").send_keys("Санкт")
        time.sleep(2)
        driver.find_element_by_xpath("//span[@id='tableFieldItemForm:city_panel']/ul/li/span").click()
        ...
        driver.find_element_by_id("tableFieldItemForm:street_input").send_keys(u"Граф")
        driver.find_element_by_xpath("//span[@id='tableFieldItemForm:street_panel']/ul/li/span").click()
        ...
        driver.find_element_by_id("tableFieldItemForm:house_input").send_keys("1")
        ...
        driver.find_element_by_id("tableFieldItemForm:comment").send_keys("Динозаврики")
        driver.find_element_by_id("tableFieldItemForm:saveTableButton").click()
        time.sleep(2)
        #Контактные данные
        driver.find_element_by_id("j_idt73:j_idt92:tf_contactDataList_add").click()
        driver.find_element_by_id("tableFieldItemForm:contactType_label").click()
        driver.find_element_by_css_selector("#tableFieldItemForm\:contactType_panel").click()
        driver.find_element_by_css_selector("#tableFieldItemForm\:contactType_1").click()
        driver.find_element_by_id("tableFieldItemForm:data").click()
        driver.find_element_by_id("tableFieldItemForm:data").clear()
        driver.find_element_by_id("tableFieldItemForm:data").send_keys("Динозаврики@mail.ru")
        driver.find_element_by_id("tableFieldItemForm:j_idt194").click()
        driver.find_element_by_id("tableFieldItemForm:saveTableButton").click()
        time.sleep(2)
        #Документ, удостоверяющий личность
        driver.find_element_by_id("j_idt73:j_idt92:tf_identityDocuments_add").click()
        driver.find_element_by_id("tableFieldItemForm:identityDocumentsType_label").click()
        driver.find_element_by_css_selector("#tableFieldItemForm\:identityDocumentsType_panel").click()
        driver.find_element_by_css_selector("#tableFieldItemForm\:identityDocumentsType_2").click()
        driver.find_element_by_id("tableFieldItemForm:series").click()
        driver.find_element_by_id("tableFieldItemForm:series").clear()
        driver.find_element_by_id("tableFieldItemForm:series").send_keys("4477")
        ...
        driver.find_element_by_id("tableFieldItemForm:identityDocumentsNumber").send_keys("1234567")
        driver.find_element_by_id("tableFieldItemForm:issuedBy").click()
        driver.find_element_by_id("tableFieldItemForm:issuedBy").clear()
        driver.find_element_by_id("tableFieldItemForm:issuedBy").send_keys("УФМС ДИНОЗАВРИКИ")
        ...
        driver.find_element_by_id("tableFieldItemForm:issuedDate_input").send_keys("12.12.2000")
        ...
        driver.find_element_by_id("tableFieldItemForm:issuedCode").send_keys("123456")
        ...
        driver.find_element_by_id("tableFieldItemForm:validity_input").send_keys("12.12.2222")
        driver.find_element_by_id("tableFieldItemForm:saveTableButton").click()
        time.sleep(2)
