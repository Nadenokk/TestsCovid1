...
class BankDetails(unittest.TestCase):
    ...
    def test_bank_details(self):
        ...
        driver.find_element_by_id("files-form:edit-folder-tabView:name").send_keys(namefile)
        ...
        driver.find_element_by_xpath("//div[@id='files-form:j_idt114']//li[@data-item-value='file']//a[@id='files-form:j_idt118']").click()
        driver.find_element_by_id("itemForm:tabView:name").click()
        driver.find_element_by_id("itemForm:tabView:name").clear()
        namefile = self.generate_random_string()
        driver.find_element_by_id("itemForm:tabView:name").send_keys(namefile)
        driver.find_element_by_id("itemForm:tabView:description").click()
        driver.find_element_by_id("itemForm:tabView:description").clear()
        driver.find_element_by_id("itemForm:tabView:description").send_keys("123")
        driver.find_element_by_css_selector("#itemForm\:tabView\:assignee_label").click()
        driver.find_element_by_id("itemForm:tabView:assignee_label").click()
        driver.find_element_by_id("itemForm:tabView:assignee_2").click()
        ...
        button = driver.find_element_by_id("itemForm:tabView:j_idt106_input")
        button.send_keys(
        ...
        order2 = driver.find_element_by_xpath("//tbody[@id='files-form:file-datatable_data']/tr[" + str(1) + "]/td[" + str(5) + "]").text
        ...
        order2 = driver.find_element_by_xpath(
        ...
        driver.find_element_by_id("itemForm:tabView:description").clear()
        driver.find_element_by_id("itemForm:tabView:description").send_keys("123")
        driver.find_element_by_id("itemForm:tabView:sender").send_keys("ФБУН")
        ...
        driver.find_element_by_id("itemForm:tabView:description").clear()
        driver.find_element_by_id("itemForm:tabView:description").send_keys("123")
        driver.find_element_by_id("itemForm:tabView:receiver").send_keys("ФБУН")
        ...
        driver.find_element_by_id("itemForm:tabView:assignee_label").click()
        driver.find_element_by_id("itemForm:tabView:assignee_2").click()
        driver.find_element_by_css_selector("#itemForm\:tabView\:client_label").click()
        driver.find_element_by_id("itemForm:tabView:client_label").click()
        driver.find_element_by_id("itemForm:tabView:client_1").click()
        driver.find_element_by_css_selector("body.main-body").click()
        driver.find_element_by_id("itemForm:tabView:validUntil_input").send_keys("07.09.2021 09:48")
        driver.find_element_by_css_selector("#itemForm\:tabView\:workType_label").click()
        ...
        driver.switch_to.window(window_before)
        time.sleep(2)
        driver.find_element_by_id("itemForm:tabView:contractCost_input").send_keys("300")
        driver.find_element_by_xpath(
            "//li[@class='ui-tabs-header ui-state-default ui-corner-top' and @data-index='1']").click()
        button = driver.find_element_by_id("itemForm:tabView:j_idt106_input")
        button.send_keys(
        ...
        driver.find_element_by_id("itemForm:tabView:paymentDate_input").send_keys("07.09.2021")
        driver.find_element_by_id("itemForm:tabView:reportDateFrom_input").send_keys("07.09.2021")
        ...
        driver.switch_to.window(window_before)
        time.sleep(2)
        driver.find_element_by_id("itemForm:tabView:amount_input").send_keys("300")
        driver.find_element_by_id("itemForm:tabView:previouslyAmount_input").send_keys("123")
        driver.find_element_by_xpath(
            "//li[@class='ui-tabs-header ui-state-default ui-corner-top' and @data-index='1']").click()
        button = driver.find_element_by_id("itemForm:tabView:j_idt106_input")
        button.send_keys(
