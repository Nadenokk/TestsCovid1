...
class BankDetails(unittest.TestCase):
    ...
    def test_bank_details(self):
        ...
        driver.find_element(By.ID,"form:usernameInput").send_keys("log")
        driver.find_element(By.ID,"form:passwordInput").click()
        driver.find_element(By.ID,"form:passwordInput").clear()
        driver.find_element(By.ID,"form:passwordInput").send_keys("log")
        ...
        driver.find_element(By.ID,"files-form:j_idt83").click()
        ...
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").send_keys("Файлы")
        ...
        driver.find_element(By.ID,"files-form:edit-folder-tabView:type_0").click()
        ...
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").clear()
        namefile = self.generate_random_string()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").send_keys("Общие документы")
        driver.find_element(By.CSS_SELECTOR,"#files-form\:edit-folder-tabView\:type_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:type_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:type_1").click()

        driver.find_element(By.CSS_SELECTOR,"body.main-body").click()
        driver.find_element(By.CSS_SELECTOR,"#files-form\:edit-folder-tabView\:icon_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:icon_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:icon_18").click()
        ...
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").clear()
        namefile = self.generate_random_string()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").send_keys("Входящие документы")
        driver.find_element(By.CSS_SELECTOR,"#files-form\:edit-folder-tabView\:type_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:type_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:type_2").click()
        ...
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").clear()
        namefile = self.generate_random_string()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").send_keys("Исходящие документы")
        driver.find_element(By.CSS_SELECTOR,"#files-form\:edit-folder-tabView\:type_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:type_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:type_3").click()
        ...
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").clear()
        namefile = self.generate_random_string()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").send_keys("Договоры")
        driver.find_element(By.CSS_SELECTOR,"#files-form\:edit-folder-tabView\:type_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:type_label").click()
        ...
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").clear()
        namefile = self.generate_random_string()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").send_keys("Счета")
        driver.find_element(By.CSS_SELECTOR,"#files-form\:edit-folder-tabView\:type_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:type_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:type_5").click()
        ...
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").clear()
        namefile = self.generate_random_string()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:name").send_keys("Акты")
        driver.find_element(By.CSS_SELECTOR,"#files-form\:edit-folder-tabView\:type_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:type_label").click()
        driver.find_element(By.ID,"files-form:edit-folder-tabView:type_6").click()
