...
class Kupon(unittest.TestCase):
    ...
    def test_kupon(self):
        ...
        driver.find_element_by_id("j_idt71:j_idt82").click()
        time.sleep(2)
        ...
        driver.find_element_by_id("productForm:j_idt141").click()
        time.sleep(6)
        driver.find_element_by_css_selector("#j_idt71\:j_idt78 > div:nth-child(3) > span.ui-icon.ui-icon-triangle-1-s.ui-c").click()
        driver.find_element_by_css_selector(
            "#j_idt71\:j_idt78_panel > div.ui-selectcheckboxmenu-items-wrapper > ul > li:nth-child(1)").click()
        time.sleep(2)
        driver.find_element_by_id("j_idt71:j_idt78").click()
        driver.find_element_by_id("j_idt71:j_idt78_1").click()
        driver.find_element_by_id("j_idt71:j_idt82").click()
        driver.find_element_by_id("productForm:prodName").send_keys("100inH")
        driver.find_element_by_id("productForm:j_idt141").click()
        driver.find_element_by_id("j_idt71:j_idt78").click()
        driver.find_element_by_id("j_idt71:j_idt78_2").click()
        driver.find_element_by_id("j_idt71:j_idt82").click()
